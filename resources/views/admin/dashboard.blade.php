...
<div class="row g-4 mb-5">
    @php $statCards = [
        ...
        ['label'=>'Revenus totaux',   'value'=> number_format($stats['total_revenue'],0,',',' ').' FCFA',
         'sub'  => "Aujourd'hui : ".number_format($stats['today_revenue'],0,',',' ').' FCFA',
         'icon' =>'bi-cash-coin',     'color'=>'#16a34a', 'bg'=>'#dcfce7', 'trend'=>'+'],
